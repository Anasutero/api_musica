...
# método get com id especifico consumindo a API DO Deezer
...
async def get_musicas_id(id_musica):
    ...
    try:
        ...
        url = f'https://deezerdevs-deezer.p.rapidapi.com/track/{MUSICAS[id_musica]}' 
...
#Para que o codigo seja rodado automaticamente, 
#sem a necessidade de ficar matando o terminal e rodando-o novamente o uvicorn
